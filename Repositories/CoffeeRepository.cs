...
namespace MinimalApp.Repositories
{
    public static class CoffeeRepository
    {
        public static List<CoffeeModel> Coffees = new()
        {
            ...
            new() { Id = 3, Name = "Latte", Description = "A tall, mild 'milk coffee'. An espresso with and only a little milk foam poured over it"},
            ...
            new() { Id = 5, Name = "Cappucino", Description = "A coffee drink consisting of espresso and a milk foam mixture"},
        };
    }
}
